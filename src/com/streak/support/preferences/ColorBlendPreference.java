...
package com.streak.support.preferences;
...
import com.streak.support.colorpicker.ColorPickerDialog;
...
public class ColorBlendPreference extends Preference
    ...
    private void updateDialogSliderPreview() {
        ...
        mDialogPreviewColorBetween.setBackgroundColor(
                StreakUtils.getBlendColorForPercent(mPreviewColorEnd, mPreviewColorStart,
    ...
    private void updatePreview() {
        ...
        if (mViewColorBetween != null) {
            mViewColorBetween.setBackgroundColor(
                    StreakUtils.getBlendColorForPercent(mColorEnd, mColorStart, mBlendReverse, 50));
        }
    }
